        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Invoice_StartDate_Less_Than_EndDate", "[StartDate] < [EndDate]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InvoiceRow_Quantity_Positive", "[Quantity] > 0");
                    table.CheckConstraint("CK_InvoiceRow_Rate_Positive", "[Rate] > 0");
                    table.CheckConstraint("CK_InvoiceRow_Sum_Positive", "[Sum] > 0");
                    table.ForeignKey(
